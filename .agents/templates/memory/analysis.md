...
{State assumptions, their confidence, and what would invalidate them.}
...
{Reason from the evidence and assumptions. Keep inference distinguishable from observed fact.}
...
{State missing evidence, uncertainty, risks, and questions that prevent stronger reliance or promotion.}
