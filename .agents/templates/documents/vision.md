...
{Explain the present problem or opportunity, why existing approaches are insufficient, and why this direction is valuable.}

## Scope

{Explain what or whom the vision serves, what belongs to the effort, and the breadth within which the promise applies.}

## Principles

{Keep only the few identity-defining principles needed to understand what this vision must remain as it evolves.}
