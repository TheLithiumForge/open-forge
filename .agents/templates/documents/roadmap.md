...
{State what this roadmap coordinates, the time or outcome horizon, and what planning remains elsewhere.}
...
{Describe intended outcomes in meaningful order. Avoid turning the roadmap into a task dump.}

## Dependencies And Decision Points

{State relationships that constrain sequence and the choices or evidence that may change it.}
...
{Explain what evidence, constraints, or decisions should cause the roadmap to be revised.}
