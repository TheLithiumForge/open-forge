...
{Link to the vision and state the part of it this strategy currently pursues.}

## Strategic Thesis

{Explain why this approach is expected to work in the current context.}

## Focus

{State the few areas where attention and resources will concentrate.}

## Choices And Non-Choices

{State what this strategy deliberately favors and what it declines, postpones, or leaves open.}

## Assumptions

{State the material assumptions on which the strategy depends and how they may be tested.}
