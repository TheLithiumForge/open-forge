...
- [current top-down structure, project graph, dependency model, evidence, and delivery sequence for the non-shipping C# replacement CLI.](../memory/crystallized/documents/cli/architecture.md) - #CurrentTruth #Evergreen #Architecture #CLI #Replacement #NativeAOT #Document
