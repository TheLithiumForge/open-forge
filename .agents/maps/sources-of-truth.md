...
- [accepted Gate 3 architecture of the non-shipping C# replacement CLI, including its physical source and test topology, Native AOT boundary, filesystem and recovery model, result protocol, evidence, and release shape.](../memory/crystallized/documents/cli/architecture.md) - #CurrentTruth #Evergreen #Architecture #CLI #Replacement #NativeAOT #Document
...
- [current detailed replacement CLI command contracts under their final `contracts/` route, including final `index/` and `references/` scopes.](../memory/crystallized/documents/cli/contracts/_contracts.md) - #CurrentTruth #Evergreen #CLI #Replacement #Contract #Document
...
- [active evidence, decisions, disposition, and gate state for the new CLI program.](../memory/working/cli-release/_cli-release.md) - #Contextual #CLI #Release #Program
