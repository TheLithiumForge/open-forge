...
1. Read the Task, accepted contracts and architecture, baseline, complete branch diff and commits, phase evidence, Purple result, public-surface scenario, full-gate evidence, and applicable source rules without inheriting the implementer's conclusion.
...
5. Report explicitly when no blocking finding remains and provide residual risk or an unproved boundary. The Mastermind groups the report with its integrated inspection and decides whether the exceptional correction cycle is worth its cost.
