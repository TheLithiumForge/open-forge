---
open-forge:
  description: Write clear, consistent user communication and Open Forge source prose with proportionate authoring and review
...
- Ordinary Working Memory and task-state updates must not create a writing-review phase unless the user explicitly requests it or the prose is about to become public or durable authority substantially unchanged.
- Use a Writing Reviewer only for public documentation, Crystallized or equivalent durable prose, prose intended to move there substantially unchanged, or an explicit review request. Review the coherent changed pack once, not each file separately.
- Validate links, examples, commands, generated navigation, and requirement strength proportionately. The primary owner always inspects the actual final prose.
