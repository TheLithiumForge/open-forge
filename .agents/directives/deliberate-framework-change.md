...
- Establish or update the authoritative directive, pattern, decision, or current document before or with a framework contract change so implementation follows written current truth.
