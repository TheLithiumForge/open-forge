...
- Route files use description-labelled Markdown links with useful tags; local destinations resolve relative to the route file, and external destinations use their normal URL
