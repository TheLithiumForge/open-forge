---
open-forge:
  description: Completed transfer note for dependency-safe extensions, workflow-first routing, Git-checkpointed installation, and reproducible harness hardening
