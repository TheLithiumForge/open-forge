...
- `2026-07-15_harness-and-extensions.md` - Completed transfer note for dependency-safe extensions, workflow-first routing, Git-checkpointed installation, and reproducible harness hardening - #Memory #Handoff #AgentCommunication #Contextual #Extension #CLI #Benchmark #Reliability
