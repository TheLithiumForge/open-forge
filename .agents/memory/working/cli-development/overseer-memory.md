...
4. Task 4 “Route Move” is Complete at accepted closeout `631983ea`, tree
   ...
   16 Doctor. Task 14 “Extension Install” (phase 2/5): milestone 1/8 — Gray is
   freezing the four accepted decisions and smallest typed callable boundary
   from isolated activation `f1ebd9b6`, tree `20e1035f`. Status and Doctor completely
...
| Task 14 Extension Install     | Install reviewed Extension packages with isolated lifecycle and recovery integrity     | Active at phase 2/5, milestone 1/8; isolated activation `f1ebd9b6`, tree `20e1035f`, records the accepted result/presentation, interaction, lifecycle-last ordering, and `.agents/**` payload decisions plus the deferred non-authoritative `.apm/**` idea; Gray is active and production is not                                                                  |
