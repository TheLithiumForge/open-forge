...
4. Task 4 “Route Move” is Complete at accepted closeout `631983ea`, tree
   ...
   16 Doctor. Task 14 “Extension Install” (phase 2/5): milestone 2/8 — immutable
   Gray contract `fb8b98c8`, tree `8217ae57`, and receipt `2c3918ae`, tree
   `35bedaa2`, freeze the four accepted decisions and smallest typed callable
   boundary. Separate bounded Red evidence is being frozen with production
   untouched. Status and Doctor read-only preparation is complete, but both
...
| Task 14 Extension Install     | Install reviewed Extension packages with isolated lifecycle and recovery integrity     | Active at phase 2/5, milestone 2/8; Gray `fb8b98c8` and receipt `2c3918ae` are immutable; bounded Red Unit, Integration, and published-process evidence is being frozen with production untouched; `.agents/**` remains authoritative and `.apm/**` deferred                                                                                                      |
