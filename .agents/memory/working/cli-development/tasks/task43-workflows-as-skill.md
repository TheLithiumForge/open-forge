...
The 2026-09-21 [documentation packet](../../../archived/cli-development/tasks/beta-follow-ups/task42-43-documentation.md) maps the shipped native Skill, catalogue and template and specifies stale-contract repairs. The earlier problem statement below is historical context. No additional routing behavior is approved by this update.
