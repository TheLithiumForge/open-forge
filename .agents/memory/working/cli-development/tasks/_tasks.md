...
- [ ] [Read-Only Commands](read-only/_read-only.md) — Active; Find, References, Context, Extension List, and Routed Authored Metadata are Complete; Extension Inspect implementation is independent and Generated Navigation is Active for rebase/completion — Implementer: Overseer
