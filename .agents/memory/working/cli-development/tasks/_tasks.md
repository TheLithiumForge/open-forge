...
- [ ] [CLI Architecture Authority Remediation](cli-architecture-authority-remediation.md) — Task 12 is prepared after integrated Route Move and before the adoption slice; mutation awaits authority-destination acceptance and executable behavior remains protected — Implementer: Dedicated Task Mastermind with one Brilliant Implementer and one fresh review
