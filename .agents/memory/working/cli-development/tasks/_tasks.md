...
- [ ] [Route Mutation Commands](route-mutation/_route-mutation.md) — Active: Route Init, Route Create, and [CLI Quality Remediation](cli-quality-remediation.md) are Complete; remediation is squash-integrated at `862cbf2a`, exact tree `571f104f`; Route Update is next — Implementer: Overseer-managed command lanes
