...
- [ ] [Lifecycle Commands](lifecycle/_lifecycle.md) — Active: Extension Create and root Install command-local Green; exact Install JSON wire schema frozen; protected integration remains sequential — Implementer: Overseer-managed command lanes
