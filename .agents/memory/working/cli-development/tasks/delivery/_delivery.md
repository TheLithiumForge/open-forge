...
Matching-host execution and delivery acceptance remain separately tracked.
...
- [ ] [Expand Task 7 to the accepted ARM64 packages](01-npm-packages.md#arm64-expansion-horizon) — Active after Task 27, phase 4/4, milestone 5/6; review and complete local gates accepted
