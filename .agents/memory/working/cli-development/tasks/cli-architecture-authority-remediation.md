...
open-forge:
  ...
  tags: [Memory, Working, Contextual, Complete, CLI, Task, Architecture, Authority, Documentation, Remediation]
---
...
- Responsible role: A dedicated Task Mastermind in the isolated
  ...
  `/home/tedy/dev/open-forge-worktree/cli-architecture-authority-remediation`
