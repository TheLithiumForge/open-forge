...
- Next meaningful project boundary: complete Route Move's grouped M6
  corrections, behavior, review, and gates while Task 12 completes bounded
  preparation. Then integrate Route Move, activate Task 12 mutation, and proceed
  through the prioritized Extension Install, Status, and Doctor slice. Task 13
