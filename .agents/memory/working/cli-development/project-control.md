...
- Next meaningful project boundary: complete Route Move's grouped M6
  corrections, behavior, review, and gates. Then integrate Route Move, activate
  the prepared Task 12 mutation after destination approval, and proceed through
  the prepared Extension Install boundary, Status, and Doctor. Task 13 remains
