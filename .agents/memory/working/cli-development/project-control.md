...
| Task 21 “CLI Command Surface Remediation”              | [CLI Command Surface Remediation](tasks/cli-command-surface-remediation.md)                     | `ACTIVE`    | Not applicable   | Correct the seven validated audit findings within existing contracts and refactoring authority.                     | Phase 2/4, milestone 2/6; qualified Red accepted, Green active.                                  | Bounded sequential remediation                           | Branch `codex/cli-command-surface-remediation`; accepted base `8463a2e2`.                                                                                                                                                                                                                   | Root owner; one continuous Astra/high implementer.                                                                          | Task capsule owns seven-ID scope, protected meaning and proportional gates.                                                                                                                                                                                                                                                                           |
| Task 27 “C# Structural Streamlining”                   | [C# Structural Streamlining](tasks/csharp-structural-streamlining.md)                           | `QUEUED`    | Not applicable   | Assess remaining C# internals and implement justified simplifications beyond the strategic audit.                   | After Task 21, before Task 7 ARM64 expansion; horizon unassigned.                                | Sequential structural assessment and bounded refactoring | Accepted source base selected after Task 21.                                                                                                                                                                                                                                                | Root Overseer; substantive assistance Astra/high.                                                                           | Reconcile prior coverage, freeze concrete findings, preserve behavior and qualify focused/combined evidence.                                                                                                                                                                                                                                          |
| Task 7 “npm Package Manager Release and Local Linking” | [ARM64 expansion](tasks/delivery/01-npm-packages.md#arm64-expansion-horizon)                    | `QUEUED`    | Not applicable   | Extend the accepted package graph to Linux, macOS and Windows ARM64 while retaining x64.                            | New horizon after Task 27, before Task 13; phase/milestone unassigned.                           | Bounded package expansion                                | Current base selected at activation.                                                                                                                                                                                                                                                        | Root Overseer; implementation unassigned.                                                                                   | Earlier 8/8, 7/7 and 5/5 horizons remain complete; six-target native proof is not yet available.                                                                                                                                                                                                                                                      |
