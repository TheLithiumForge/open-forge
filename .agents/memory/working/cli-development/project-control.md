...
local integration of the final prose/source freeze is next.
...
| Task 25 “Workspace Library Destination Projections”      | [Workspace Library Destination Projections](tasks/workspace-library-destination-projections.md) | `COMPLETE`    | 2                | Implement folder-scoped leaf links, optional destination mapping and recursive Library grants.                      | Phase 5/5, milestone 8/8; acceptance complete, local integration next.                                         | Streamlined assured                 | Branch `codex/library-destination-projections`, base `de1e1b7a`.                                                                                                                                                                                                                            | Root, direct sequential continuation.                                                                                       | Managed 2820/1559/188; native 1559/188; managed-on-native 188. All pass, no skips; M7 all findings closed.                                                                                                                                                                                                                                            |
