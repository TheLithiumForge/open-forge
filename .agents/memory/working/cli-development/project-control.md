...
| Task 24 “Extensions Evolution”                           | [Extensions Evolution](tasks/extensions-evolution.md)                                           | `COMPLETE`    | 2                | Decide Extension package vocabulary and consumer-owned destination permissions beyond `.agents`.                    | Phase 5/5, milestone 8/8; full acceptance complete.                                                                        | Queued post-command behavior task   | Accepted source at e541d574 plus verified analyzer corrections; final feature commit and local integration follow.                                                                                                                                                                          | Root sequential owner; Astra/high reviewer completed.                                                                       | Managed2719/1518/188; native1518/188; managed-on-native188. Zero failures/skips/warnings and format diagnostics.                                                                                                                                                                                                                                      |
...
- Active: root completes local integration of accepted Task 24.
...
- Blocker: Task 25 awaits the user's explicit-path versus eligible-source-file
  selection decision. No further product decision blocks Task 24 integration.
