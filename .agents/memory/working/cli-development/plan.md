...
- Current accepted baseline: Context and Extension List are Complete and squash-integrated at
  `ca097a2` and `db0d39a`. The combined accepted baseline passes managed Unit
...
- Current tasks: [Extension Inspect](tasks/read-only/extension-inspect.md) exact
  contract closure and the [pure Generated Navigation
  foundation](tasks/read-only/index-generated-navigation-foundation.md).
- Current step: run the authorized parallel wave for Extension Inspect exact
  contract closure and the pure Generated Navigation foundation. Public Index
...
| E1  | Active   | Extension List is Complete and integrated at `db0d39a`; close Extension Inspect's exact public result/finding/fingerprint contract before its production implementation.                                                                                                                                                                                                                                                         | G1, GI1                                 | Read-only C | Extension discovery  | Catalogue, package-source, lifecycle, process, and AOT      |
| GN1 | Active   | Establish the pure Generated Navigation projection and bounded-region fact foundation with no command or effects.                                                                                                                                                                                                                                                                                                                | Q1-Q3, R2                               | Read-only D | Generated navigation | Determinism, exact bytes, no-write, and affected regressions |
