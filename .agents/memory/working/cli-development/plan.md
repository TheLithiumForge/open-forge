...
- Task 6's two subsequent progress-update grace is consumed and it is dequeued.
  Task 17 “Extension Update” is Complete at phase 5/5, milestone 8/8, on branch
  `codex/extension-update-implementation` from exact base
  ...
  `T17-R1` and correction `T17-C1` are consumed. Stop after Task 17 acceptance
  without activating Task 18.
...
archived intact. Task 17 is Complete; Task 18 remains `QUEUED` and inactive.
...
Task 17 “Extension Update” is Complete at phase 5/5, milestone 8/8, and Task 6
is dequeued after its consumed completion grace. Stop without activating Task 18
or changing the later queue.
