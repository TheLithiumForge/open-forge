...
| E1  | Pending  | Implement and accept `extension list` and `extension inspect`                                                               | G1         | Read-only C | Extension discovery  | Catalogue and package-source evidence        |
...
| Read-only A/B | Q1, Q2                         | R2 complete and shared source contracts frozen       | Separate Find and References command roots    | Routing, documents, source catalogue | Q3                |
| Read-only C   | E1                             | G1 complete and extension source contract frozen     | Extension List/Inspect roots                  | Shell and filesystem foundation      | M1                |
