...
- Task 12 “CLI Architecture Authority Remediation” is Complete at phase 5/5,
  ...
  local-use horizon is now active at phase 2/3, milestone 3/5, alongside Task 6.
  Its exact prose and both focused reviews passed; candidate refreeze and commit
  precede a reversible local npm link from a reviewed integrated restored tree.
  ARM and publication remain unauthorized.
...
| T7   | Historical horizons complete; provisional local-use horizon active at phase 2/3, milestone 3/5                                                                                                                                                | Preserve the accepted x64 package graph while aligning Loader guidance, recording the unaccepted centralized `.agents` idea, and preparing one reviewed, reversible local link from the integrated restored tree.                                                                                                                                                                                                                                                                                                                              | Accepted package graph and current CLI      | Parallel disjoint prose/local-use lane with M3         | Distribution and local developer use    | Loader parity and both reviews pass; candidate refreeze, exact pre-link request, and isolated smoke after release                                                                      |
...
| Next commands    | C1, C2, C3, C4, M4A, M2, M3                            | C1 complete at `4c85d1d6`; C3 at `fa3db1ee`; C2 at `c60fcb98`; C4 Route Init at `cc5085ce`; Route Create at `19412d2`; QR1 at `862cbf2a`; Route Update at `27df8325`; Route Move at `631983ea`; Task 12 at `495a7ed6`; Task 14 at `20807781`; Route Remove at `5a2e650a`; Root Update Green under review | Separate Extension Create/Install, Route Inspect/Init/Create/Update/Move/Remove, and root Update paths; QR1 consumed Route Create's two predecessor slices | Root composition, serialization, help, process, recovery, lifecycle, and AOT evidence | Task 7, Status, Doctor, and Route Remove historical horizons complete; Root Update `T6-R1` active. |
| Task 7 local use | Provisional horizon active at phase 2/3, milestone 3/5 | Historical x64 graph complete; Loader/idea prose and both focused reviews pass beside Task 6, with live link deferred until reviewed integration and exact release.                                                                                                                                      | Loader source/dogfood/maintenance and idea/control prose only; package source remains protected                                                            | Accepted npm graph and the verified restored integrated tree                          | Candidate commit, local smoke, receipt, then D1/A1                                                 |
