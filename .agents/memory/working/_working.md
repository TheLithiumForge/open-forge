...
- [CLI modularization investigation and rationale behind the accepted migration direction](cli-modularization-review.md) - #Memory #Working #CLI #Architecture #Testing #Contextual
- [Accepted CLI migration sequence, Sol-led Luna swarm batches and overseer handover](cli-development/tasks/task38/_task38.md) - #Memory #Working #CLI #Architecture #Plan #Contextual #Active

- [Minimal current backlog after the replacement-CLI working-state cleanup](backlog.md) - #Memory #Working #Backlog #Contextual
