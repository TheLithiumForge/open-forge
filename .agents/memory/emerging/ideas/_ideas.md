...
- [Rebuild the MVP CLI around the accepted ACE architecture, preservation-first lifecycle semantics, and deterministic reasoning acceleration](cli-overhaul.md) - #Memory #Idea #Contextual #Candidate #CLI #Architecture #Product #Refactor
