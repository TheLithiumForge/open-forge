---
open-forge:
  description: Accepted Framework rationale for routing, authority, Core roles, Memory, Markdown, packaging, and user-facing writing
  tags: [Memory, Decision, CurrentTruth, Framework, Rationale]
---
