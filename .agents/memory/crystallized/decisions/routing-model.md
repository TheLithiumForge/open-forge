...
- `open-forge load --bodies` is optional batched traversal of the loader, transitive visible #LoadNow closure in generated order, and complete #KeepInMind catalogue at required baseline and continuity refresh boundaries. It does not traverse an on-demand parent merely because a hidden descendant carries #LoadNow, and plain-file traversal remains complete. (revised 2026-07-26)
