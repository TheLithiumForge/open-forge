...
`src/open-forge/` is the installable Framework payload. Its `AGENTS.md` is the canonical root instruction contract, and minimal harness bridges may import it without duplicating policy.
