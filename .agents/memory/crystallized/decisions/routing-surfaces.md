...
Primitive-specific contracts may add narrower semantics. Directives become binding after their route establishes scope, #KeepInMind uses its defined continuity discovery boundary, and Workflow metadata supports wayfinding without becoming the execution recipe.
...
- Treating Workflow phases as execution order would turn wayfinding metadata into ceremony
