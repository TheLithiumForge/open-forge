...
- Core managed, scoped-framework, and generated-index writes are also one rollback-capable operation with link/hardlink and Git-visibility preflight.
...
- Final extension design still needs route templates, trust/provenance receipts, compatibility/version solving, crash-recovery journaling, persistent install/update/remove behavior, and richer authoring helpers.
