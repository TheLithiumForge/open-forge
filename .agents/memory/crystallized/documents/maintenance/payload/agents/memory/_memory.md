...
- Core installation closure tests verify the complete Memory `route` set, root authority wording, `managed route` reconciliation through scopes, and generated navigation
