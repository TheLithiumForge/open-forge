...
The [Archived state contract](../../../../framework/memory/archived.md) defines historical meaning and authority. The [transition contract](../../../../framework/memory/transitions.md#supersession-and-archival) owns extraction and restoration across state boundaries.
