---
open-forge:
  description: Current maintenance contracts for reviewed files in the installable Open Forge payload
  tags: [Memory, Document, CurrentTruth, Evergreen, Maintenance, Governance, Payload]
---

# Payload Maintenance

This route follows the structure of `src/open-forge/` as its files are reviewed and migrated.
