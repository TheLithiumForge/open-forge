...
- [Current documents for the Open Forge CLI MVP role, behavior, architecture, safety, verification, and liabilities](cli/_cli.md) - #Memory #Document #CurrentTruth #Architecture #CLI #MVP
