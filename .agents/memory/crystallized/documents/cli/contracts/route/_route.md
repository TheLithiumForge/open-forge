...
`route` command family. All seven leaves are implemented and locally accepted;
the replacement CLI remains unreleased. The [CLI Development](../../../../../working/cli-development/_cli-development.md)
route records implementation and evidence state. This entrypoint defines group
routing and help only. The child
