...
- [Accepted technology-neutral behavior for deterministic read-only Extension list facts and ownership observations](behavior.md) - #Memory #Crystallized #CLI #Release #Command #Contract #Extension #List #Behavior #ReadOnly #Determinism #Lifecycle #CurrentTruth
