...
- [`result-coordinates/`](result-coordinates/_result-coordinates.md) routes the
...
- No command-local Technical Design file is created for these shared contract
  sets. Exact shared-capability realization is routed separately through the
  [CLI Technical Designs](../../technical-designs/_technical-designs.md), while
  their structural implementation boundaries remain in the CLI Architecture.
