...
apply the contract do not ship yet; implementation and executable proof remain
pending Gate 5. The [CLI Architecture](../../../architecture.md) defines the
shared result, filesystem, runtime, and evidence boundaries; this behavior
defines only selector resolution and set meaning.
