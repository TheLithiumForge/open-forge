...
The [CLI Architecture](../../../architecture.md) defines the BCL-first
filesystem and physical-identity boundary, shared result envelope,
process-status mapping, runtime, and evidence boundary. This behavior remains
