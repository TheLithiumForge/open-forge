...
- [Public schema-3 envelope, source-location, status, exit, stream, and compatibility coordinates shared by CLI results](interface.md) - #Memory #Crystallized #CLI #Release #Command #Contract #Shared #Interface #Result #JSON #Status #Compatibility #CurrentTruth
