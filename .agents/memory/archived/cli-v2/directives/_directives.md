---
open-forge:
  description: Historical CLI-v2 Directive sources removed from active governance
  tags: [Memory, Archived, Contextual, Historical, CLI, CLIv2, RawData]
---

# CLI v2 Directives

These former Directive sources are historical text. They do not bind current
work.

## Archive Rules

- Treat all descendants as historical text, not active Directives.
