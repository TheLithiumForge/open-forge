---
open-forge:
  description: Historical evidence-backed assessment of Open Forge, its post-SDD evolution, naming atlas, risks, dogfood results, and S++ options
  tags: [Memory, Archived, Analysis, Reasoning, Contextual, Historical, Framework, Review, Dogfood, Benchmark, Security, Roadmap]
---

# Open Forge Assessment: From SDD To Context-Routed Development

Status: archived 2026-07-18.  
Original route: `.agents/memory/emerging/analysis/2026-07-12_open-forge-framework-assessment.md`.  
Archived because: it is a dated assessment snapshot whose accepted conclusions and open gates were extracted to current decisions, evidence syntheses, observations, and the rating ladder.  
Current owner or replacement: crystallized decisions, `.agents/memory/crystallized/documents/evaluations/`, `.agents/memory/emerging/ideas/rating-ladder.md`, the live backlog, and current product documentation.

Date: 2026-07-12. Revised: 2026-07-13 with an expanded naming atlas and implementable S++ decision options; implementation addendum 2026-07-17. Historical candidate analysis, never accepted as current truth.
...
- Reproducible artifact-row SQL: `.agents/memory/archived/analysis/2026-07-12_open-forge-framework-assessment.sql`; it materializes only verified constants and assessment outputs, while the Markdown reports, source, and tests remain factual provenance.
