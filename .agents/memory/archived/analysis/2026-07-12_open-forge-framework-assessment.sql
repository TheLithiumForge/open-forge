-- Historical archive, moved 2026-07-18 from
-- .agents/memory/emerging/analysis/2026-07-12_open-forge-framework-assessment.sql.
-- Current owners: accepted evaluation syntheses, crystallized decisions, the
-- rating ladder, live backlog, source, documentation, and tests.
