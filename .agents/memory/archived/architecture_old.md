---
open-forge:
  description: Superseded pre-reset Open Forge architecture preserved for historical context
  tags: [Memory, Archived, Contextual, Historical, Architecture, Framework]
---

# Open Forge Architecture (Superseded)

This architecture was superseded on 2026-07-26 by the clean [top Open Forge architecture](../crystallized/documents/architecture.md). It remains historical context, not accepted current truth.
...
- [Crystallized maintenance documents](../crystallized/documents/maintenance/_maintenance.md) govern reviewed source and repository surfaces through linked contracts.
...
- [Current top architecture](../crystallized/documents/architecture.md)
- [Current maintenance contracts](../crystallized/documents/maintenance/_maintenance.md)
