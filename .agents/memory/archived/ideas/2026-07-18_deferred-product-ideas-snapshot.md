---
open-forge:
  description: Historical snapshot of deferred product ideas before the 2026-07-18 current-review pruning pass
  tags: [Memory, Archived, Idea, Contextual, Historical, Product, Extension]
---

# Deferred Product Ideas Snapshot

Status: archived 2026-07-18.  
Original route: `.agents/memory/emerging/ideas/deferred-product-ideas.md`.  
Archived because: implemented and resolved candidates were mixed with still-open product options.  
Current owner or replacement: the pruned `.agents/memory/emerging/ideas/deferred-product-ideas.md`, current decisions and documentation, and `.agents/memory/working/backlog.md`.

Deferred ideas carried from the cleanup backlog. Candidate directions, not commitments.

Implemented as optional packs on 2026-07-15 and decomposed at shared dependency seams: cross-language reliability defaults; separately selectable architecture, vision, brainstorming, implementation, testing, and mixed development flows; planning and task creation; review, refactoring, and debugging; UX exploration, design review, and implementation handoff. Shared architecture, vision, planning, implementation, and quality skills are skill-only extensions. These implementations do not accept the remaining bullets by implication.
