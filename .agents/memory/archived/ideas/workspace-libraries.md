...
open-forge:
  ...
  tags: [Memory, Idea, Contextual, CLI, Workspace, Library, Sharing, Symlink, Submodule, Security, Archived, Historical]
---
...
contracts, and Framework routes remain authoritative. The [Task 23 record](../cli-development/tasks/workspace-libraries.md)
