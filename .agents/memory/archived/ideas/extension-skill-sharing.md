---
open-forge:
  description: Historical design for native skill sharing through content-agnostic dependency extensions and one installed-path owner
  tags: [Memory, Archived, Idea, Contextual, Historical, Extension, Skill, CLI]
---
...
Current owner or replacement: `.agents/memory/crystallized/decisions/extensions-and-cli.md`, `docs/extensions.md`, and `.agents/memory/working/backlog.md`.
