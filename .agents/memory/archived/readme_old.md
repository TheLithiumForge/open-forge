---
open-forge:
  description: Superseded pre-ACE Open Forge README preserved after the public product entry was rebuilt
  tags: [Memory, Archived, Contextual, Historical, README, Product, Documentation]
---

# Superseded Open Forge README

This README was superseded on 2026-07-26 by the ACE-centered public README. It remains historical product and implementation context and does not describe the current public promise.
