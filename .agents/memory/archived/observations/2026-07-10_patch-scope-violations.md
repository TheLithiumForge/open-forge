---
open-forge:
  description: Historical evidence that prose scope intent lost to tool and process working-directory defaults in early harness runs
  tags: [Memory, Archived, Observation, Contextual, Historical, Directive, Tooling, Benchmark]
---

# Observation: Scope Violations Recur At Tool And Process Boundaries

Status: archived 2026-07-18.  
Original route: `.agents/memory/emerging/observations/2026-07-10_patch-scope-violations.md`.  
Archived because: the recurrence was resolved in the harness and retained in its accepted evaluation synthesis and operational safeguards.  
Current owner or replacement: `.agents/memory/crystallized/documents/evaluations/v7-synthesis.md`, current harness directives, runner tests, and mutation-safety guidance.
