---
open-forge:
  description: Historical context-boundary review whose escape and overwrite findings were fixed and whose remaining receipt work moved to planning
  tags: [Memory, Archived, Observation, AgentLearning, Contextual, Historical, CLI, Routing, Security, Loading]
---

# Observation: Deterministic Context Lookup Does Not Preserve Its Declared Boundaries

Status: archived 2026-07-18.  
Original route: `.agents/memory/emerging/observations/2026-07-12_find-context-boundaries.md`.  
Archived because: route containment and overwrite discovery were fixed, global #KeepInMind discovery is now intentionally binding, and optional active-context receipt work was extracted to the backlog.  
Current owner or replacement: `docs/cli.md`, current CLI tests, loading and routing decisions, the loader, and `.agents/memory/working/backlog.md`.
...
Historical status before archival: partially resolved in the 2026-07-17 CLI hardening. The Findings below preserve the original evidence; the Resolution records behavior at that time and its then-residual boundary.
