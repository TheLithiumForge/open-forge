---
open-forge:
  description: Historical schema finding that primitive ownership must be distinguished from topical Workflow and Directive tags
  tags: [Memory, Archived, Observation, AgentLearning, Contextual, Historical, CLI, Routing, Validation, Workflow, Directive]
---

# Primitive Tags Need Ownership Context

Status: archived 2026-07-18.  
Original route: `.agents/memory/emerging/observations/2026-07-17_primitive-tag-ownership.md`.  
Archived because: ownership-aware validation and black-box coverage shipped; a distinct metadata field remains conditional on future recurrence.  
Current owner or replacement: `docs/cli.md`, current doctor implementation and tests, primitive decisions, and `.agents/memory/working/backlog.md`.
