---
open-forge:
  description: Historical snapshot of the mixed Open Forge backlog before the 2026-07-18 clean-review pruning pass
  tags: [Memory, Archived, Planning, Backlog, Contextual, Historical]
---

# Pre-Review Backlog Snapshot

Status: archived 2026-07-18.  
Original route: `.agents/memory/working/backlog.md`.  
Archived because: completed work, obsolete run plans, and open priorities were mixed together and obstructed a clean current review.  
Current owner or replacement: the pruned `.agents/memory/working/backlog.md`, current evidence routes, and maintained product documentation.
...
4. Explore when time allows: `.agents/memory/archived/ideas/workspace-usage.md`, the docs-versus-crystallized reconciliation and description-rot notes in `.agents/memory/archived/analysis/2026-07-09_open-question-recommendations.md`, and the CLI design in `.agents/memory/archived/ideas/cli-design.md`.
5. Review `.agents/memory/archived/analysis/2026-07-09_open-question-recommendations.md`; promote accepted recommendations (workspace category, docs placement, loader route patterns, no native backlog route, description rubric) to `crystallized/decisions/`.
