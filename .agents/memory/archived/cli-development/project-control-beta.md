...
| --- | -------------------------------------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| 30  | [CLI Experience Remediation](../../working/cli-development/tasks/task30-cli-experience-remediation.md)         | Active                      | G1/B1/G4 complete; Phase 5-D is next                                                                       | Root, direct sequential                                |
| 31  | [Implementation Duplication Removal](../../working/cli-development/tasks/task31-implementation-duplication.md) | Open                        | M1/M2/M3/M4 complete; M5 waits for stable structure                                                        | Root, direct sequential                                |
...
| 52  | [Documentation site](../../working/cli-development/tasks/task52-documentation-site.md)                         | Active                      | Integrated into local `develop`; the maintainer merges to `main`, pushes, and enables Pages                | Root, direct sequential                                |
| 53  | [Loading and scoping audit](../../working/cli-development/tasks/task53-loading-and-scoping-audit.md)           | Open                        | Recorded for 1.0 polish; not started                                                                       | Unassigned                                             |
| 54  | [Tag trimming](../../working/cli-development/tasks/task54-tag-trimming.md)                                     | Open                        | Recorded for 1.0 polish; not started                                                                       | Unassigned                                             |
| 55  | [Alternative root](../../working/cli-development/tasks/task55-alternative-root.md)                             | Open                        | Recorded for 1.0 polish; investigation not started                                                         | Unassigned                                             |
...
On 2026-09-25 the maintainer selected [Task 52](../../working/cli-development/tasks/task52-documentation-site.md),
...
Task 51, [Public beta release](tasks/task51-beta-release.md),
...
The selected work is the [lossless source wording proposal](../beta-preparation/src-wording-proposal.md)
on a separate branch. The maintainer authorized applying its eight replacements; source and
workspace counterparts are now aligned for review. The requested [default Skill indexing task](../../working/cli-development/tasks/task47-default-skill-indexing.md)
