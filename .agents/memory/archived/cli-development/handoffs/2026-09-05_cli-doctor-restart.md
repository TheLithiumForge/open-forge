...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, Handoff, CLI, Doctor, Restart]
---
...
cd <home>/dev/open-forge-worktree/doctor-implementation
...
- Repository: `<home>/dev/open-forge`.
- Branch: `develop`.
...
- Worktree: `<home>/dev/open-forge-worktree/doctor-implementation`.
...
<home>/dev/open-forge/.apm/agents/overseer.agent.md, then read
<home>/dev/open-forge/.agents/loader.md and load the required routes.

The PC was restarted. Resume from the sealed handoff
<home>/dev/open-forge-worktree/doctor-implementation/.agents/memory/working/handoffs/2026-09-05_cli-doctor-restart.md.
...
<home>/dev/open-forge-worktree/doctor-implementation on branch
