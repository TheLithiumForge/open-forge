...
open-forge:
  ...
  tags: [Memory, Checkpoint, CLI, Contextual, Archived, Historical]
---
...
[G1 lock model](tasks/task30/phase-4a-g1.md), change by
...
1. Read the [active plan](../../working/cli-development/plan.md).
2. Read [Project Control](../../working/cli-development/project-control.md).
