...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Route, Discovery, ReadOnly, Complete]
---
...
- [Routes completed leaf Tasks for Route Discovery without changing their historical Task meaning](done/_done.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Discovery #Complete
- [Run integrated route-inspect acceptance, promotion closeout, edge dispositions, and delivery-boundary audits](route-inspect-acceptance.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Acceptance #NativeAOT #Complete
- [Freeze route-inspect callable contracts and map every guarantee to evidence before behavior](route-inspect-contracts.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Contract #Evidence #Complete
- [Complete the already-accepted Route Inspect interactive source-collision selection](route-inspect-interaction-correction.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Interaction #Correction
- [Bind, execute, and present route inspect once through compact, expanded, JSON, diagnostics, and help surfaces](route-inspect-presentation.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Presentation #Complete
- [Form the inspect-local route profile from one accepted graph and fact set without adding diagnosis or mutation](route-inspect-profile.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Profile #Complete
- [Implement and accept route inspect, then promote only route facts proved identical by both commands](route-inspect.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Inspect #Promotion #Complete
