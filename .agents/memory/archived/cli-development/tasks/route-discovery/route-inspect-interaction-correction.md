...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Route, Inspect, Interaction, Correction]
---
...
- Formatting: the inherited `DOTNET_ROOT=<home>/.dotnet` initially made
