...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Route, Inspect, Contract, Evidence, Complete]
---
...
| [Development phase workflow](../../../../../skills/use-workflow/references/open-forge/development/_development.md) and [Task Lifecycle](../../../../../skills/use-workflow/references/open-forge/development/task-lifecycle.md)                        | How Phase 0, Gray, evidence, and commits are separated                      | Phase-boundary record                      |
