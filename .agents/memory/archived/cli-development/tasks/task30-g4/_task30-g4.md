...
open-forge:
  ...
  tags: [Memory, CLI, Task, Plan, G4, Presentation, Contextual, Archived, Historical]
---
...
- [Shared rules, verification commands, message style, the shared message families, and the record-only instruction every G4 subtask follows](00-conventions.md) - #Memory #CLI #Task #Plan #G4 #Contextual #Archived #Historical
- [Capture and commit the current output of every command at both current views and both formats before any G4 behavior change](01-before-snapshots.md) - #Memory #CLI #Task #Plan #G4 #Contextual #Archived #Historical
- [Decide the names of statuses, severities, resolution lanes, states, presentation classes and flags before the rendering system uses them](02-naming.md) - #Memory #CLI #Task #Plan #G4 #Naming #Contextual #Archived #Historical
- [Redesign the rendering system around one report model, one selection stage, generic text and JSON renderers, one escaper, and the physical layout for the later project split](03-rendering-system.md) - #Memory #CLI #Task #Plan #G4 #Presentation #Architecture #Contextual #Archived #Historical
- [Design and implement the interaction system with keyboard selection, dependency marks, plan review before confirmation, and non-interactive equivalents](04-interaction-system.md) - #Memory #CLI #Task #Plan #G4 #Interaction #Contextual #Archived #Historical
- [Make index rewrite only the list of entries inside the Entries section and give status and update the same boundary](05-index-entries-region.md) - #Memory #CLI #Task #Plan #G4 #Index #Safety #Contextual #Archived #Historical
- [Status output catalogue with every status, level, format and finding message](10-status.md) - #Memory #CLI #Task #Plan #G4 #Status #Contextual #Archived #Historical
- [Doctor output catalogue with the severity ladder, coverage counts, every finding kind and its message](11-doctor.md) - #Memory #CLI #Task #Plan #G4 #Doctor #Contextual #Archived #Historical
- [Install output catalogue and confirmation flow](12-install.md) - #Memory #CLI #Task #Plan #G4 #Install #Contextual #Archived #Historical
- [Update output catalogue and confirmation flow](13-update.md) - #Memory #CLI #Task #Plan #G4 #Update #Contextual #Archived #Historical
- [Index output catalogue](14-index.md) - #Memory #CLI #Task #Plan #G4 #Index #Contextual #Archived #Historical
- [Repair output catalogue and guided selection flow](15-repair.md) - #Memory #CLI #Task #Plan #G4 #Repair #Contextual #Archived #Historical
- [Cleanup output catalogue](16-cleanup.md) - #Memory #CLI #Task #Plan #G4 #Cleanup #Contextual #Archived #Historical
- [Context output catalogue with the payload stream and its framing](17-context.md) - #Memory #CLI #Task #Plan #G4 #Context #Contextual #Archived #Historical
- [Find output catalogue](18-find.md) - #Memory #CLI #Task #Plan #G4 #Find #Contextual #Archived #Historical
- [References output catalogue](19-references.md) - #Memory #CLI #Task #Plan #G4 #References #Contextual #Archived #Historical
- [Route list output catalogue](20-route-list.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route inspect output catalogue and ambiguity prompt](21-route-inspect.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route init output catalogue and the complete-status change](22-route-init.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route create output catalogue](23-route-create.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route update output catalogue](24-route-update.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route move output catalogue](25-route-move.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Route remove output catalogue](26-route-remove.md) - #Memory #CLI #Task #Plan #G4 #Route #Contextual #Archived #Historical
- [Extension list output catalogue](27-extension-list.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Extension inspect output catalogue](28-extension-inspect.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Extension create output catalogue and input prompts](29-extension-create.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Extension install output catalogue, package selection, permission and confirmation flows](30-extension-install.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Extension update output catalogue and flows](31-extension-update.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Extension remove output catalogue and flows](32-extension-remove.md) - #Memory #CLI #Task #Plan #G4 #Extension #Contextual #Archived #Historical
- [Library list output catalogue](33-library-list.md) - #Memory #CLI #Task #Plan #G4 #Library #Contextual #Archived #Historical
- [Library inspect output catalogue](34-library-inspect.md) - #Memory #CLI #Task #Plan #G4 #Library #Contextual #Archived #Historical
- [Library attach output catalogue and permission flow](35-library-attach.md) - #Memory #CLI #Task #Plan #G4 #Library #Contextual #Archived #Historical
- [Library sync output catalogue and permission flow](36-library-sync.md) - #Memory #CLI #Task #Plan #G4 #Library #Contextual #Archived #Historical
- [Library detach output catalogue and permission flow](37-library-detach.md) - #Memory #CLI #Task #Plan #G4 #Library #Contextual #Archived #Historical
- [Cross-command invariants, snapshot regeneration and review, and the complete managed and Native AOT gate](40-verification.md) - #Memory #CLI #Task #Plan #G4 #Testing #Contextual #Archived #Historical
- [Propagate the accepted changes recorded in every subtask's changes ledger into contracts, public documentation, Directives and memory records](41-documentation-propagation.md) - #Memory #CLI #Task #Plan #G4 #Documentation #Contextual #Archived #Historical
