...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Implementation, Presentation]
---
...
worktree `<temp>/open-forge-cli-refactor-sequential`.
...
<home>/.local/bin/open-forge, a symlink to the Volta Node 24.19.0 global npm
