...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Distribution, NativeAOT, CI]
---
...
Worktree: <temp>/open-forge-delivery-stages; branch codex/delivery-stages;
...
Changes remain uncommitted in `<temp>/open-forge-local-delivery`; the main
