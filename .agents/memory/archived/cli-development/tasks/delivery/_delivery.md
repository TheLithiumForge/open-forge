...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Distribution, NativeAOT, SupplyChain, Release]
---
...
- [Prepare and prove the thin npm package graph and explicit local-link workflow](01-npm-packages.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Delivery #Npm #Package
- [Prove native CI and reproducible artifact collection for all six accepted platforms](02-native-ci.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Distribution #NativeAOT #CI
- [Preserve future signatures, SBOM, provenance, and OIDC expansion behind explicit acceptance](03-supply-chain.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Distribution #SupplyChain #Security
- [Align public documentation, accept all six targets, and prepare an authorized release](04-release.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Distribution #Documentation #Release
