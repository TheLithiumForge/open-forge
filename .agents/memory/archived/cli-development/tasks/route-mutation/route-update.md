...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Route, Update, Mutation]
---
...
- Branch and worktree: `codex/route-update` at
  `<home>/dev/open-forge-worktree/route-update`.
...
- Candidate authority is repository root
  `<home>/dev/open-forge-worktree/route-update`, committed parent
...
- Final native dogfood uses exact normalized overwrite reference
  ...
  `env XDG_DATA_HOME=<home>/dev/open-forge-worktree/route-update/.temp/m12-route-update-dogfood-final/local-data <home>/dev/open-forge-worktree/route-update/artifacts/publish/linux-x64/open-forge/OpenForge.Cli route update ./.agents/memory/project-alpha/overview.overwrite.md --description 'M12 overview' --responsibility= --tag=After --tag=Memory`,
  with `--dry-run` appended for preview, no appended mode for apply, and `--json`
  appended for repeat.
- Owner-correction native dogfood uses
  `env XDG_DATA_HOME=<home>/dev/open-forge-worktree/route-update/.temp/m12-route-update-owner-correction-dogfood/local-data <home>/dev/open-forge-worktree/route-update/artifacts/publish/linux-x64/open-forge/OpenForge.Cli route update ./.agents/memory/project-alpha/overview.md --template=.agents/templates/route.md`.
