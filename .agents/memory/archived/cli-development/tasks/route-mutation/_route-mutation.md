...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Route, Mutation]
---
...
- [Implement one-file route creation below an existing routable parent](route-create.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Create #Mutation
- [Implement generic and Framework-aware sparse route initialization after root Install](route-init.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Init #Mutation
- [Implement route move with reference, overwrite, generated-navigation, and recovery integrity](route-move.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Move #Mutation
- [Implement route removal with dependency, reference, generated-navigation, and recovery integrity](route-remove.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Remove #Mutation
- [Implement bounded route content and metadata update without identity drift](route-update.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Route #Update #Mutation
