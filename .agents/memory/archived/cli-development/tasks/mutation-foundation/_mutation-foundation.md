...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Mutation, Lifecycle, Recovery]
---
...
- [Freeze workspace-lock, lifecycle-envelope, mutation-precondition, receipt, and recovery contracts](01-contracts.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Mutation #Contract #Lifecycle #Recovery
- [Implement persistent lock ownership, lifecycle reads and writes, and expected-state revalidation](02-lock-lifecycle.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Mutation #Lock #Lifecycle
- [Implement one atomic per-file application primitive with exact verified receipts](03-apply.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Mutation #Filesystem #Atomic
- [Implement external recovery bundles and interruption boundaries for mutations](04-recovery.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Mutation #Recovery
- [Integrate and accept the mutation foundation before any mutating command](05-acceptance.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Mutation #Acceptance #Integration
