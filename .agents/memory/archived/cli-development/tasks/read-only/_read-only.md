...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, ReadOnly, Source, Extension, Index]
---
...
- [Implement ordered context selection, exact content projection, and explicit contained-link expansion](context.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Context #ReadOnly #Loading
- [Implement exact Extension package inspection without mutation or installation behavior](extension-inspect.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Extension #Inspect #ReadOnly
- [Implement Extension catalogue and source listing without lifecycle inference](extension-list.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Extension #List #ReadOnly
- [Bind, present, and accept the non-shipping Find command through its public views, JSON, diagnostics, and evidence](find-presentation-acceptance.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Find #ReadOnly #Presentation #Acceptance #NativeAOT
- [Implement the exact Find query operation over the accepted source catalogue and fixed Markdown facts](find-query-operation.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Find #ReadOnly #Query #Markdown #Matching #Projection
- [Establish the neutral Framework source catalogue and migrate Route List and Inspect without public behavior change](find-source-catalogue.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Find #ReadOnly #Sources #Route #Framework #Architecture
- [Author and accept deterministic CommonMark-aware source discovery and Find projections](find.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Find #ReadOnly #Markdown
- [Implement deterministic generated Entries projection and idempotent index application](index-command.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Index #Generated #Mutation
- [Establish pure deterministic Generated Navigation projection and bounded-region facts without effects](index-generated-navigation-foundation.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Index #Generated #Framework #ReadOnly
- [Implement direct incoming and outgoing reference facts with shared source-universe filters](references-command.md) - #Memory #Archived #Contextual #Historical #CLI #Task #References #ReadOnly #Links
- [Promote one neutral routed authored-metadata fact for Open Forge Markdown and native Skills](routed-authored-metadata-foundation.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Framework #Sources #Metadata #ReadOnly #Index
