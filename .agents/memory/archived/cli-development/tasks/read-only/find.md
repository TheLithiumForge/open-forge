...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Find, ReadOnly, Markdown]
---
...
| [Task Lifecycle](../../../../../skills/use-workflow/references/open-forge/development/task-lifecycle.md)                                                                                                                                                                   | Which Preflight, phase, review, and commit boundaries apply?                                      | Applicable Workflow.                                                                                                                                     |
