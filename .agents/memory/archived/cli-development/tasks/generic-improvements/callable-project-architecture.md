...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Generic, Callable, Architecture, Project, Refactoring, Complete]
---
...
| [Task Lifecycle](../../../../../skills/use-workflow/references/open-forge/development/task-lifecycle.md)                   | Which Task, phase, review, commit, and acceptance boundaries apply?                                                      | Applicable Workflow                                        | No.                                                          |
