...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Generic, Testing, Locality, Architecture, Refactoring, Complete]
---
...
| [Task Lifecycle](../../../../../skills/use-workflow/references/open-forge/development/task-lifecycle.md)                         | How does one bounded Purple phase reach review and acceptance?                       | Applicable Workflow           | No.                                                                                                                            |
