...
open-forge:
  ...
  tags: [Memory, Archived, Contextual, Historical, CLI, Task, Generic, Parser, Testing, Architecture, Complete]
---
...
- [Task Lifecycle](../../../../../skills/use-workflow/references/open-forge/development/task-lifecycle.md).
...
- [Improve active-test locality and reuse without changing test meaning or CLI behavior](active-test-architecture.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Generic #Testing #Locality #Architecture #Refactoring #Complete
- [Close callable-input and root-host/Core architecture decisions before the behavior-neutral CLI refactor](callable-project-architecture.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Generic #Callable #Architecture #Project #Refactoring #Complete
- [Replace generic parser rescans and terminal bypass gaps with pinned library facts and typed validation](parser-remediation.md) - #Memory #Archived #Contextual #Historical #CLI #Task #Generic #Parser #SystemCommandLine #Evidence #Complete
