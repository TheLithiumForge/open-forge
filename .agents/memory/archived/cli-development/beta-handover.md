...
open-forge:
  ...
  tags: [Memory, CLI, Handover, Beta, Contextual, Archived, Historical]
---
...
[The task index](../../working/cli-development/tasks/_tasks.md) opens with the full ordering and the reason
