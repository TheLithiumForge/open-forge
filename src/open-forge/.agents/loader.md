...
- Users may add, move, replace, or remove `routes`; `routes` outside a manager's declared shapes remain generically routable, and removed defaults stay absent unless restoration is explicitly requested
