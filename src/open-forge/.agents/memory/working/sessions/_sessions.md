...
open-forge:
  ...
  tags: [OpenForge, Memory, Session, WorkHistory, Index, Contextual, LoadWithParentEntrypoint]
---

# Sessions

Sessions are raw chronological memory records of work while it happens.
...
- Extract useful material to the owner of its new state: another #Memory route, a matching #Core route, an external system, or archived history.
- Prefer the narrowest session route that can answer the current question.
