...
open-forge:
  ...
  tags: [OpenForge, Memory, Crystallized, Index, CurrentTruth, LoadWithParentEntrypoint]
---
...
- This entrypoint exposes accepted current memory routes.
...
- Load only the crystallized memory bodies and child categories relevant to the current request.
...
- `documents/_documents.md` - Durable accepted records and routes to them - #OpenForge #Memory #Document #Index #CurrentTruth
