...
describe("install", () => {
  test("installs merged core category entrypoints", async () => {
    ...
    expect(emergingMemory).toContain("- `observations/_observations.md` - Useful noticed findings that may become durable memory - #OpenForge #Memory #Observation #Index #Contextual #Candidate");
    ...
    expect(observationsMemory).toContain("Observations are useful noticed findings that may matter later.");
