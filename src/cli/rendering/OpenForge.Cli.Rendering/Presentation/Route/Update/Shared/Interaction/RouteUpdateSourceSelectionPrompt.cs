...
namespace OpenForge.Cli.Core.Presentation.Route.Update.Shared.Interaction;

internal static class RouteUpdateSourceSelectionPrompt
{
    internal static CliPrompt<RouteUpdateSourceSelectionQuestion, string> Create(
        CliPrompts prompts)
    {
