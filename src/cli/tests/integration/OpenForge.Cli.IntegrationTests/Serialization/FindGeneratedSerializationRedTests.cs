...
public sealed class FindGeneratedSerializationRedTests
{
    ...
    public void FindDocumentUsesGeneratedMetadata()
    {
        ...
        var metadata = CliJsonContext.Default.FindJsonDocument;
    ...
    private static string Serialize(FindJsonDocument document)
        => JsonSerializer.Serialize(document, CliJsonContext.Default.FindJsonDocument);
