...
public sealed class StatusFiniteMappingTests
{
    ...
    public void FindingCodesMapToExactMachineNamesAndStatusesAndUndefinedValueFailsClosed()
    {
        var expected = new (StatusFindingCode Code, string MachineName, CliSemanticStatus Status)[]
        {
            ...
            (StatusFindingCode.LibraryRecordMalformed, "library-record-malformed", CliSemanticStatus.Blocked),
            (StatusFindingCode.LibraryRecordUnavailable, "library-record-unavailable", CliSemanticStatus.Incomplete),
            (StatusFindingCode.LibrarySourceRootInvalid, "library-source-root-invalid", CliSemanticStatus.Blocked),
            (StatusFindingCode.LibrarySourceRootAliased, "library-source-root-aliased", CliSemanticStatus.Blocked),
            (StatusFindingCode.LibrarySourceRootUnavailable, "library-source-root-unavailable", CliSemanticStatus.Incomplete),
            (StatusFindingCode.LibraryProjectionMissing, "library-projection-missing", CliSemanticStatus.Attention),
            (StatusFindingCode.LibraryProjectionChanged, "library-projection-changed", CliSemanticStatus.Attention),
            (StatusFindingCode.LibraryProjectionUnavailable, "library-projection-unavailable", CliSemanticStatus.Incomplete),
            (StatusFindingCode.LibraryProjectionBlocked, "library-projection-blocked", CliSemanticStatus.Blocked),
            (StatusFindingCode.LibraryExtensionCollision, "library-extension-collision", CliSemanticStatus.Blocked),
