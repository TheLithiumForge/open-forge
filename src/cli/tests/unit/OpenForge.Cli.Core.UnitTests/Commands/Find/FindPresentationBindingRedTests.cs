...
public sealed class FindPresentationBindingRedTests
{
        ...
        int expectedDiagnosticCalls)
    {
        ...
        var operation = new FindOperation(new FindOperationComponents
        {
            ...
            FrontmatterFactsReader = _ => throw new InvalidOperationException("The failed boundary must stop before frontmatter parsing."),
