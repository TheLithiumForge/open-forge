...
public sealed class FindOperationRedTests
{
    ...
    public async Task OperationReadsOneBoundaryAndFormsUniverseBeforeLayers(string selectorForm)
    {
        ...
        var operation = new FindOperation(components);
    ...
    private static FindOperationComponents CreateComponents(
        OperationFixture fixture,
        IList<string> calls,
        bool routeFacts,
        FindSourceBoundaryReader? sourceBoundaryReader = null,
        ...
        FindSelectedLayerReader? selectedLayerReader = null)
    {
        ...
        var boundaryReader = sourceBoundaryReader
            ?? ((_, _) =>
            {
                calls.Add("boundary");
                fixture.SourceBoundaryCalls++;
                return ValueTask.FromResult(new FindSourceReadContext(
                    fixture.Catalogue,
                    sourceReader,
        ...
        return new FindOperationComponents
        {
            ...
            MarkdownDocumentReader = readMarkdown,
            FrontmatterFactsReader = readFrontmatter,
            ResultBuilder = new OpenForge.Cli.Core.Commands.Find.Shared.Result.FindResultBuilder(),
        };
    }
