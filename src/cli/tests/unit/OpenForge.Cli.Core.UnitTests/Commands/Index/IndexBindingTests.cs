...
{
    [Fact(DisplayName = "Index symbols expose the exact direct-root operands and idempotent dry-run option"), Trait("Feature", "index-command"), Trait("Evidence", "Unit"), Trait("Boundary", "Input")]
    ...
    [Fact(DisplayName = "Index binding preserves source occurrence order and repeated dry-run as one typed request"), Trait("Feature", "index-command"), Trait("Evidence", "Unit"), Trait("Boundary", "Input")]
    ...
    [Fact(DisplayName = "Index binding reports malformed source occurrences without retaining raw operands"), Trait("Feature", "index-command"), Trait("Evidence", "Unit"), Trait("Boundary", "Input")]
