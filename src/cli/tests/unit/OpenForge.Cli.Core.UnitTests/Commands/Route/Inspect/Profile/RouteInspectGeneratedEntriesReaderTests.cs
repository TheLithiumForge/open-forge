...
{
    [Fact(DisplayName = "Route inspect rejects whitespace-only outer lines around generated Entries markers")]
    [Trait("Feature", "route-inspect"), Trait("Evidence", "Unit")]
    public void WhitespaceOnlyOuterLinesRemainUnavailable()
    {
