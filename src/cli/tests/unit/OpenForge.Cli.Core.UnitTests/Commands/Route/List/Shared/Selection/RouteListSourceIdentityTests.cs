...
public sealed class RouteListSourceIdentityTests
{
    ...
    {
        Assert.Equal(expectedId, RouteListSourceIdentity.DeriveId(canonicalPath));
    }
    ...
    {
        Assert.Null(RouteListSourceIdentity.DeriveId(null!));
        Assert.Null(RouteListSourceIdentity.DeriveId(""));
        Assert.Null(RouteListSourceIdentity.DeriveId("loader.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId("other/.agents/root.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId("./.agents/root.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents/"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents//root.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents/./root.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents/../root.md"));
        Assert.Null(RouteListSourceIdentity.DeriveId(".agents/root\\root.md"));
    }
}
