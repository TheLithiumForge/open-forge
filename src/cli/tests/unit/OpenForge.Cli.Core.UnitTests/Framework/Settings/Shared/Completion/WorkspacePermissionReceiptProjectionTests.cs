...
namespace OpenForge.Cli.Core.UnitTests.Framework.Settings.Shared.Completion;
...
public sealed class WorkspacePermissionReceiptProjectionTests
{
    ...
    {
        var path = Path.GetFullPath(Path.Combine("permission-unit", ".agents", "open-forge.json"));
