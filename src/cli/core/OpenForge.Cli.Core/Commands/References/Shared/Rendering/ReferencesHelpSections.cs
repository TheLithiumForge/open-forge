    ...
    internal static CliHelpContent Create()
        ...
        [
            new CliHelpSection(
                ...
                + "[--include <source-reference>]... [--exclude <source-reference>]... [global options]"),
            new CliHelpSection(
            ...
            new CliHelpSection(
                "Incoming filters",
                "  --include and --exclude each consume one source reference each time. "
                + "All includes are combined, exclusions take priority, and filters apply only to incoming references. They cannot be used with --direction out."),
            new CliHelpSection(
                "Global options",
            ...
            new CliHelpSection(
                "Notes",
                "  References is a deterministic, read-only report of direct references. It does not fetch URLs, load target bodies, "
