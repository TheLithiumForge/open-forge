...
internal static class UpdateDefinitions
{
    ...
    internal static string ReadMachineName(UpdateComparisonCurrentState value)
        => value switch
        {
            ...
            UpdateComparisonCurrentState.BaselineEquivalent => "baseline-equivalent",
    ...
    internal static UpdateFindingDefinition Read(UpdateFindingCode code)
    {
        ...
        return code switch
        {
            ...
            UpdateFindingCode.ManagedDivergence => Definition(code, "update.managed-divergence", CliSemanticStatus.Attention),
            UpdateFindingCode.ManagedTargetMissing => Definition(code, "update.managed-target-missing", CliSemanticStatus.Attention),
        ...
        UpdateMode mode)
    {
        ...
        return status switch
        {
            ...
            CliSemanticStatus.Blocked => new CliNextAction(
                UpdateDefinitions.DoctorCommand,
            ...
            CliSemanticStatus.Attention when findings.Any(finding =>
                ...
                UpdateDefinitions.CleanupCommand,
