...
internal static class UpdatePlanningPolicy
{
        ...
        UpdatePlanningAuthority authority)
    {
        ...
        return comparison.IntendedState switch
        {
            UpdateComparisonIntendedState.Same => ReadCurrentDisposition(
                comparison,
                authority,
                baselineEquivalent: UpdatePlanningDisposition.NoOp),
            UpdateComparisonIntendedState.Changed => ReadCurrentDisposition(
                comparison,
                authority,
                baselineEquivalent: UpdatePlanningDisposition.Replace),
    ...
    private static UpdatePlanningDisposition ReadCurrentDisposition(
        UpdateComparison comparison,
        UpdatePlanningAuthority authority,
        UpdatePlanningDisposition baselineEquivalent)
        => comparison.CurrentState switch
        {
            UpdateComparisonCurrentState.BaselineEquivalent => baselineEquivalent,
            UpdateComparisonCurrentState.FormatOnly => baselineEquivalent,
            UpdateComparisonCurrentState.Changed => authority.Force
                ? UpdatePlanningDisposition.Replace
                : UpdatePlanningDisposition.Preserve,
            UpdateComparisonCurrentState.Missing => authority.Force
                ? UpdatePlanningDisposition.Restore
                : UpdatePlanningDisposition.Preserve,
