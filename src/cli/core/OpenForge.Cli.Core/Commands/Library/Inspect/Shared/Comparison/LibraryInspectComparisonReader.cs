...
internal sealed class LibraryInspectComparisonReader(PhysicalPathResolver resolver, CliWorkspace workspace)
{
    ...
    internal LibraryInspectComparisonRead Read(LibraryRecord selected, LibraryInventory? inventory, CancellationToken cancellationToken)
    {
    ...
    internal static LibraryRegisteredPath[] RegisteredPaths(LibraryRecord selected)
