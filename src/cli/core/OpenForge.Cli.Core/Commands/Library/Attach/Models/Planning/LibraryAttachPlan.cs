...
internal sealed record LibraryAttachPlan
{
    ...
    public required LibraryAttachPlanningInput Input { get; init; }
    ...
    public required ImmutableArray<LibraryAttachFinding> Findings { get; init; }
}
