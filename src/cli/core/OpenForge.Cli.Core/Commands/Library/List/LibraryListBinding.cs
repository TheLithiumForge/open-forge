...
internal static class LibraryListBinding
{
    ...
    internal static CliCommandBinding<LibraryListRequest, LibraryListResult> Close(LibraryListSymbols symbols, LibraryListBindingComponents components)
    {
        ArgumentNullException.ThrowIfNull(symbols);
        ArgumentNullException.ThrowIfNull(components);
        return new CliCommandBinding<LibraryListRequest, LibraryListResult>(symbols.Command,
            new CliCommandBindingComponents<LibraryListRequest, LibraryListResult>
            {
