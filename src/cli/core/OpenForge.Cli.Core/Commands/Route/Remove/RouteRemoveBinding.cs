    ...
    RouteRemoveInvalidResultFactory invalidResultFactory)
{
    ...
    internal RouteRemoveSymbols CreateSymbols(Command routeGroup)
    {
        ...
        return new RouteRemoveSymbols(routeGroup, command, sourceReference, dryRun);
    }
        ...
        RouteRemoveSymbols symbols)
    {
        ...
        return CliBindResult<RouteRemoveRequest, RouteRemoveResult>.Bound(
            new RouteRemoveRequest(workspace, facts.SourceReference, facts.Mode));
    }

    internal CliCommandBinding<RouteRemoveRequest, RouteRemoveResult> Close(
        RouteRemoveSymbols symbols,
        RouteRemoveBindingComponents components)
    {
        ArgumentNullException.ThrowIfNull(symbols);
        ArgumentNullException.ThrowIfNull(components);
        return new CliCommandBinding<RouteRemoveRequest, RouteRemoveResult>(
            symbols.RemoveCommand,
            new CliCommandBindingComponents<RouteRemoveRequest, RouteRemoveResult>
            {
