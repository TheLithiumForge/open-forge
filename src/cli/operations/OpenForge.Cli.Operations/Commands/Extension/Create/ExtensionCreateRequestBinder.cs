...
internal sealed class ExtensionCreateRequestBinder(ExtensionCreateSymbols symbols)
{
        ...
        CliInvocation invocation)
    {
        ...
        var path = CliOptionResultFactsReader.ReadValue(result, _symbols.Path);
        var name = CliOptionResultFactsReader.ReadValue(result, _symbols.Name);
        var description = CliOptionResultFactsReader.ReadValue(result, _symbols.Description);
        var packageVersion = CliOptionResultFactsReader.ReadValue(result, _symbols.PackageVersion);
        var dependencies = CliOptionResultFactsReader.ReadValues(result, _symbols.Dependency);
