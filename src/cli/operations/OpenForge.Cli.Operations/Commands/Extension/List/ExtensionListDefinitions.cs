...
internal static class ExtensionListDefinitions
{
    ...
    internal static string ReadFindingCode(ExtensionListFindingCode code)
        => code switch
        {
            ...
            ExtensionListFindingCode.InstalledSourceMissing => "extension-list.installed-source-missing",
            ExtensionListFindingCode.InstalledSourceUnavailable => "extension-list.installed-source-unavailable",
            ExtensionListFindingCode.InstalledSourceInvalid => "extension-list.installed-source-invalid",
            ExtensionListFindingCode.InstalledSourceBlocked => "extension-list.installed-source-blocked",
            ExtensionListFindingCode.InstalledFilesChanged => "extension-list.installed-files-changed",
            ExtensionListFindingCode.InstalledFilesMissing => "extension-list.installed-files-missing",
            ExtensionListFindingCode.InstalledTargetUnavailable => "extension-list.installed-target-unavailable",
            ExtensionListFindingCode.InstalledTargetBlocked => "extension-list.installed-target-blocked",
            ExtensionListFindingCode.InstalledFilesUnavailable => "extension-list.installed-files-unavailable",
            ExtensionListFindingCode.OwnershipObservation => "extension-list.ownership-observation",
    ...
    internal static CliNextAction FailedNext { get; } = new(
        command: "open-forge extension list --detail debug",
    ...
    internal static CliNextAction InterruptedNext { get; } = new(
        command: CommandLines.ExtensionList,
