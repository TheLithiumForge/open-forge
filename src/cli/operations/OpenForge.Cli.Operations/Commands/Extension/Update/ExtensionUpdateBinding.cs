...
internal static class ExtensionUpdateBinding
{
    ...
    internal static CliRequestBinding<ExtensionUpdateRequest, ExtensionUpdateResult> CreateRequestBinding(
        ...
        ExtensionUpdateOperation operation)
    {
        ...
        return new CliRequestBinding<ExtensionUpdateRequest, ExtensionUpdateResult>
        {
