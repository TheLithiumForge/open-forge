...
internal static class ExtensionRemoveBinding
{
    internal static ExtensionRemoveSymbols CreateSymbols(Command extensionGroup)
    {
        ...
        stableIds.Validators.Add(result =>
        {
        ...
        return new ExtensionRemoveSymbols(command, stableIds, automatic, dryRun, allowPath);
    }

    internal static CliRequestBinding<ExtensionRemoveRequest, ExtensionRemoveResult> CreateRequestBinding(
        ...
        ExtensionRemoveOperation operation)
    {
        ...
        return new CliRequestBinding<ExtensionRemoveRequest, ExtensionRemoveResult>
        {
        ...
        CliPresentation presentation)
    {
        ...
        return new ExtensionRemoveRequest(
            ...
            automatic,
            allowInteraction: presentation.Format == CliFormat.Text && !automatic,
            allowPath: [.. CliOptionResultFactsReader.ReadValues(result, symbols.AllowPath)]);
    }
