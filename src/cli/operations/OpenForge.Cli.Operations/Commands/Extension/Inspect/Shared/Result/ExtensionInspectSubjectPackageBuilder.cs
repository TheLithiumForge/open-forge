...
internal static class ExtensionInspectSubjectPackageBuilder
{
        ...
        ExtensionInspectSubjectPackageInput input)
    {
        ...
        var inspectLifecycle = ExtensionInspectPackageLifecycleBuilder.ReadLifecycle(input.Ownership);
        ...
        ExtensionInspectEventSubjectPackageInput input)
    {
        ...
        return new ExtensionInspectEventSubjectPackageFacts
        {
            ...
            Lifecycle = input.Ownership is null
                ? null
                : ExtensionInspectPackageLifecycleBuilder.ReadLifecycle(input.Ownership),
            Installed = input.Ownership is null
                ? null
