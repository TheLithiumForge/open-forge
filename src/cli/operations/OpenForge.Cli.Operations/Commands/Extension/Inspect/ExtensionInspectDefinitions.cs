...
internal static class ExtensionInspectDefinitions
{
    ...
    internal static readonly CliNextAction FailedNext = new(
        "open-forge extension inspect --detail debug",
    ...
    internal static string ReadFindingCode(ExtensionInspectFindingCode code)
        => code switch
        {
            ...
            ExtensionInspectFindingCode.OwnershipObservation => "extension-inspect.ownership-observation",
    ...
    internal static CliSemanticStatus ReadFindingStatus(ExtensionInspectFindingCode code)
        => code switch
        {
            ...
            ExtensionInspectFindingCode.DependencyChanged
                or ExtensionInspectFindingCode.PathChanged or ExtensionInspectFindingCode.PathMissing or ExtensionInspectFindingCode.PathNew
            ...
            ExtensionInspectFindingCode.SourceInvalid
                ...
                => CliSemanticStatus.Invalid,
            ExtensionInspectFindingCode.OwnershipObservation => CliSemanticStatus.Complete,
