    ...
    ExtensionInstallFinding? Finding)
{
    internal bool IsVerified => Finding is null
        ...
        && Verification.ExtensionsLifecycle is ExtensionInstallVerificationState.Verified or ExtensionInstallVerificationState.NotRequested
        && Verification.FrameworkLifecycle is ExtensionInstallVerificationState.Verified or ExtensionInstallVerificationState.NotRequested;
}
