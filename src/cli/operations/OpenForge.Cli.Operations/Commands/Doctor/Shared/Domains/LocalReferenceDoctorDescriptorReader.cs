...
internal static class LocalReferenceDoctorDescriptorReader
{
    internal static DoctorFindingDescriptor? Read(LocalReferenceObservation observation)
    {
        ...
        {
            SourceLinkTargetResolution.Complete => null,
            ...
            SourceLinkTargetResolution.Unreadable => DoctorDomainSupport.Warning(
                DoctorFindingKind.ReferenceTargetUnreadable,
                "The target cannot be read completely.",
                DoctorResolutionLane.BlockedRepair),
            ...
            SourceLinkTargetResolution.ExternalUnchecked => null,
