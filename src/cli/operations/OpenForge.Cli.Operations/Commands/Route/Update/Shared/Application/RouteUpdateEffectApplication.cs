...
internal sealed class RouteUpdateEffectApplication(RouteUpdateFileApplication applyFile)
{
    private readonly RouteUpdateFileApplication _applyFile = applyFile;
