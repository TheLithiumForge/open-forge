...
internal sealed record RouteMoveSemanticPlanProjection
{
    ...
    private static OwnershipObservation ProjectLifecycle(WorkspaceOwnershipRead value)
        => new(value.State, value.Cause, value.Snapshot?.Expectation,
            RouteOwnershipEvidence.Claims(value).ToImmutableArray());
