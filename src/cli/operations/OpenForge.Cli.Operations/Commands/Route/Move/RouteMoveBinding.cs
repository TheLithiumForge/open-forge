    ...
    RouteMoveInvalidResultFactory invalidResultFactory)
{
    ...
    internal CliRequestBinding<RouteMoveRequest, RouteMoveResult> CreateRequestBinding(
        RouteMoveSymbols symbols,
        RouteMoveBindingComponents components)
    {
        ArgumentNullException.ThrowIfNull(symbols);
        ArgumentNullException.ThrowIfNull(components);
        return new CliRequestBinding<RouteMoveRequest, RouteMoveResult>
        {
            Command = symbols.MoveCommand,
