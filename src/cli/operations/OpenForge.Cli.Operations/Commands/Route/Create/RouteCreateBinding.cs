...
internal static class RouteCreateBinding
{
    ...
    internal static CliRequestBinding<RouteCreateRequest, RouteCreateResult> CreateRequestBinding(
        RouteCreateSymbols symbols,
        RouteCreateBindingComponents components)
    {
        return new CliRequestBinding<RouteCreateRequest, RouteCreateResult>
        {
