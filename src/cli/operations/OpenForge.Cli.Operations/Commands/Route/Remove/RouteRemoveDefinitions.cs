...
internal static class RouteRemoveDefinitions
{
    ...
    internal const string VerboseRouteRemoveCommand = "open-forge route remove --detail debug";
    ...
    internal static readonly CliOptionDefinition<bool> Automatic = new(
        "--automatic",
        "Apply the planned removal without asking for confirmation.",
        CliOptionArity.None,
        false);
    ...
    internal static string ReadMachineName(RouteRemoveFindingCode code)
        => code switch
        {
            ...
            RouteRemoveFindingCode.ConfirmationRequired => RouteRemoveFindingCodes.ConfirmationRequired,
...
internal static class RouteRemoveFindingCodes
{
    ...
    internal const string ConfirmationRequired = "route-remove.confirmation-required";
...
internal static class RouteRemoveNextActions
{
    ...
    internal static CliNextAction Automatic(string sourceReference)
        => new(
            $"open-forge route remove \"{sourceReference}\" --automatic",
            "Rerun Route Remove with --automatic.");

    internal static CliNextAction RetryableBlock { get; } = new(
        CommandLines.RouteRemove,
