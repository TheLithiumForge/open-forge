...
internal sealed record FindPresentationSelection
{
    ...
    {
        if (suppliedDetail is { } requestedView && !Enum.IsDefined(requestedView))
        {
            throw new ArgumentOutOfRangeException(nameof(suppliedDetail), suppliedDetail, "The Find supplied view is not defined.");
        }
