                ...
                InstallResult.Invalid(
                    ...
                    [
                        new InstallFinding(
                            ...
                            invocation.WorkspaceRequest.ExplicitPath
                                ?? invocation.WorkspaceRequest.CurrentDirectory),
                    ]));
        }

        var allowsInteractiveConfirmation = invocation.Presentation.Format == CliFormat.Text
            && !input.Automatic
