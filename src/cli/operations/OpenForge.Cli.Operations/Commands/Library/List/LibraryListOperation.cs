...
internal sealed class LibraryListOperation
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return record.State == LibraryRegistrationReadState.Complete
        ...
        LibraryRegistrationRead read)
    {
            ...
            && read.OwnershipObservation is { } cause)
        {
            return Event(request, CliSemanticStatus.Complete, OwnershipRecordState(read.State),
                LibraryCoverage.Complete, LibraryListFindingCode.OwnershipObservation, cause);
        }
        ...
        LibrarySourceRootObservation source)
    {
        (LibraryListFindingCode Code, CliSemanticStatus Status)? mapped = source.State switch
        {
            ...
            LibrarySourceRootState.Missing
                ...
                or LibrarySourceRootState.Unavailable => (LibraryListFindingCode.SourceRootUnavailable, CliSemanticStatus.Attention),
