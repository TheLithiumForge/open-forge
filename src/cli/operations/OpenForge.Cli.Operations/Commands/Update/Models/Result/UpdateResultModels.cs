...
internal sealed record UpdateResultFormation
{
    ...
    public bool PreviousContentAvailable { get; init; }
...
internal sealed record UpdateResult : ICliCommandResult
{
    internal UpdateResult(UpdateResultFormation formation)
    {
        ...
        PreviousContentAvailable = formation.PreviousContentAvailable;
        Mode = formation.Mode;
    ...
    internal bool PreviousContentAvailable { get; }
    ...
    internal UpdateResult ForPlanReview()
        => new(new UpdateResultFormation
        {
            Workspace = Workspace,
            PreviousContentAvailable = PreviousContentAvailable,
        ...
        IReadOnlyList<UpdatePhysicalEffect> effects)
    {
        ...
        var ordered = protectedPaths
            .OrderBy(path => path == WorkspaceOwnershipDefinitions.RelativePath ? 1 : 0)
            .ThenBy(
