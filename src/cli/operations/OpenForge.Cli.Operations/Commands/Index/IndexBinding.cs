...
internal static class IndexBinding
{
    ...
    internal static CliRequestBinding<IndexRequest, IndexResult> CreateRequestBinding(
        IndexSymbols symbols,
        CliHelpContent help,
        CliOperation<IndexRequest, IndexResult> operation)
    {
        var resultBuilder = new IndexResultBuilder();
        return new CliRequestBinding<IndexRequest, IndexResult>
        {
            Command = symbols.IndexCommand,
            Help = help,
