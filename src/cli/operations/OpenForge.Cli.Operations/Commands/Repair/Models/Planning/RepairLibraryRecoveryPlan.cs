...
internal sealed record RepairLibraryPlanningInput
{
    ...
    public required ImmutableArray<RepairRelinkRequest> PromptRelinks { get; init; }
    public required ImmutableArray<RepairLibraryRecoveryProposal>? PromptLibraries { get; init; }
}
