...
{
    internal IReadOnlyList<GeneratedNavigationMetadataIssue> MetadataIssues { get; init; } = [];
}

internal sealed record GeneratedNavigationMetadataIssue
{
    internal GeneratedNavigationMetadataIssue(string path, string cause)
    {
