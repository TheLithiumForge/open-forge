...
internal static class FoundationProbe
{
    ...
    internal static Task<FoundationResult> RunAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return RunFilesystemProbeAsync(
    ...
    private static async Task<FoundationResult> RunFilesystemProbeAsync(
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var json = JsonSerializer.Serialize(
                snapshot,
                FoundationJsonContext.Default.FoundationSnapshot);
    ...
    private static bool ObserveExclusiveLock(string path)
    {
        ...
        try
        {
            using var contender = new FileStream(
                path,
                FileMode.Open,
                FileAccess.ReadWrite,
                FileShare.None);
    ...
    {
        return new FoundationRejected(
            new FoundationFailure(
                FoundationFailureKind.InvalidInput,
                "Foundation probe input is invalid."));
    }
    ...
    private static FoundationRejected RejectFilesystem()
    {
        return new FoundationRejected(
            new FoundationFailure(
                FoundationFailureKind.Filesystem,
                "Foundation probe filesystem access failed."));
    }
}
