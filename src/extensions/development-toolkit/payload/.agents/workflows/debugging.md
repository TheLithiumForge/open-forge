...
Connect an observed symptom to a reproducible root cause and, when mutation is authorized, a minimal verified fix.
...
6. If mutation is authorized, define regression evidence and apply the smallest cause-level correction. Do not mask the symptom or weaken a valid expectation.
7. Rerun the reproduction, regression evidence, and proportionate neighboring verification.
