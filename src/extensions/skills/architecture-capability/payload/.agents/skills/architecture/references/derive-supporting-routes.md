# Derive Supporting Architecture Routes
...
- Use crystallized decisions for accepted rationale and consequences. Keep unaccepted directions in emerging memory.
- Add operational material only when the design needs explicit security, observability, deployment, reliability, scaling, rollback, or ownership support.

For every candidate, record its destination and primitive type, user-stated/observed/inferred provenance, evidence, confidence, expected consumer, purpose, and user-accord status.

Promote normative #Core or #CurrentTruth material only with user accord. Otherwise keep useful candidates emerging when authorized, report a proposed destination, or state that no material is warranted.
