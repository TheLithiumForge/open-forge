...
`--pro` intentionally bypasses the Git/Core lifecycle checks only. It never bypasses dependency, manifest, containment, portable collision, link, index, preservation, or rollback safety.
